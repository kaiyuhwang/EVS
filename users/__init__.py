...
from .transformer_expansion import TransformerModelBaseExpansion, Embedding
from .transformer_user import (TransformerModelExpansion, expansion_architecture)
...
__all__ = [
    ...
    "DEFAULT_MAX_TARGET_POSITIONS",
    "DEFAULT_MIN_PARAMS_TO_WRAP",
    "TransformerModelBaseExpansion",
    "TransformerModelExpansion",
