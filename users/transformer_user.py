...
# )
from .transformer_expansion import (TransformerModelBaseExpansion)

@register_model("transformer_expansion")
class TransformerModelExpansion(TransformerModelBaseExpansion):
    """
...
@register_model_architecture("transformer_expansion", "transformer_expansion")
def expansion_architecture(args):
